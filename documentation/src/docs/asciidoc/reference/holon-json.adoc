...
* Full `PropertyBox` type mapping support
...
[[PropertyBox]]
== `PropertyBox` data type handling
...
The Holon platform JSON module currently supports the link:http://wiki.fasterxml.com/JacksonHome[Jackson] and  link:https://github.com/google/gson[Gson] libraries out-of-the-box.
