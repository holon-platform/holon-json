...
import static com.holonplatform.json.gson.test.TestJaxrsIntegration.NUM;
import static com.holonplatform.json.gson.test.TestJaxrsIntegration.SET;
import static com.holonplatform.json.gson.test.TestJaxrsIntegration.STR;
...
import com.holonplatform.json.gson.test.TestJaxrsIntegration.TestEndpoint;
...
public class TestRestTemplate extends JerseyTest {
	...
	static class Config {
		...
		public RestTemplate restTemplate() {
			...
			GsonConfiguration.configure(rt);
			return rt;
		}
