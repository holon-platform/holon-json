...
This is the __JSON__ module of the [Holon Platform](https://holon-platform.com) and provides support for the [JSON](http://www.json.org) data-interchange format using the must popular JSON serialization and deserialization libraries:
